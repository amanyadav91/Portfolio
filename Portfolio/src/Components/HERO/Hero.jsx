    ...
    return (
        <div className="Hero bg-[#EDD8FF] h-full">
            <div className="herosection  flex justify-center items-center py-20">
                ...
                <div className="photo relative w-2/4">
            ...
            <div className="box flex ml-20 gap-1 w-[35%]">
                {box.map((item, index) => (
                    <div key={index} className="box px-2 bg-[#a43dff85] flex-1 mb-16">
